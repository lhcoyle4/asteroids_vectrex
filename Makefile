...
# --- Sources ------------------------------------------------------------------
SRC = src/main.c src/vector_graphics.c src/game.c src/player.c src/state.c src/game_data.c src/vector_font.c src/audio.c src/ui.c src/world_builder.c src/ai.c
OBJ = $(SRC:.c=.o)
